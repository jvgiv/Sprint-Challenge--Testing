...
Describe allows you to section off your tests so you can group them properly.  Describe holds as many it() functions as you want it to

1. What is the point of `Test Driven Development`? What do you think about this approach?
Test driven dev is where you write the tests first and then write the code.  I am not the biggest fan of this.
